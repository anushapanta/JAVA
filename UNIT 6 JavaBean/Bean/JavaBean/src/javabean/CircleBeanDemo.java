 ...
 * @author user
 */
public class CircleBeanDemo extends javax.swing.JFrame {

    /**
     * Creates new form CircleBeanDemo
     */
    public CircleBeanDemo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CircleBeanDemo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CircleBeanDemo().setVisible(true);
            }
        });
    }
